...
import it1 from "@/public/Dep/it1.jpg"
import it2 from "@/public/Dep/it2.jpg"
import it3 from "@/public/Dep/it3.jpg"
import it4 from "@/public/Dep/it4.jpg"

export function BentoGridThirdDemo() {
  return (
    (<BentoGrid className="container px-4 mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          key={i}
          title={item.title}
          ...
          header={item.header}
          className={cn("[&>p:text-lg] bg-background/40", item.className)}
          icon={item.icon} />
      ))}
    </BentoGrid>)
  );
