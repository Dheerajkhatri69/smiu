...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="container mx-auto flex flex-col items-center py-10 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-50">
      <motion.h2
        style={{
        ...
        {<TextGenerateEffect words={title } /> || (
          <TextGenerateEffect words={"HI i am dheeraj"} />
        )}
      </motion.h2>
      {/* Lid */}
      <Lid
