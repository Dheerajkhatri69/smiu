...
export const TextRevealCard = ({
  ...
  return (
    (<div
      ...
      ref={cardRef}
      className={cn(
        "bg-[#1d1c20] border container mx-auto border-white/[0.08] rounded-lg p-8 relative overflow-hidden",
        className
      )}>
      {children}
      <div className="h-40  relative flex items-center overflow-hidden">
        ...
        <div
          ...
          <p
            className="text-[2rem] md:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#323238]">
            {text}
          </p>
          <MemoizedStars />
        </div>
