...
export const Cover = ({
  ...
  return (
    (<div
      ...
      ref={ref}
      className="relative bg-neutral-900 bg-background/40  group/cover inline-block dark:bg-neutral-900 px-2 py-2  transition duration-200 rounded-sm">
      <AnimatePresence>
        {hovered && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <motion.span
        ...
        className={cn(
          "inline-block text-primary relative z-20 group-hover/cover:text-white transition duration-200",
          className
        )}>
        {children}
      </motion.span>
